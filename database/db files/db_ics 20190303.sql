...
(24, 22, 'student', 'myra', 'roi', 'myra@gmail.com', '70fe19c13a4007bd60b3b30ca92b8c191f0ba12e', '2017-04-16 16:04:13', '2019-03-03 17:16:32', 1),
...
CREATE TABLE `activity_logs` (
  ...
  `acitivity_datetime` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Amatong', 'Roi Larrence', 'Reyes', '397547641_276704011_911184039.jpeg', '2017-02-01 04:00:41', '2019-01-21 07:54:39', b'1');
...
(39, 12, 2, 6, 'B', 1, 1, 0, 0, 0, 0, '10:00:00', '13:30:00', 'NE28'),
...
(46, 30, 2, 15, NULL, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL);
...
(22, 'SM2012-00120', 'Abduhari', 'Myra', 'Dandun', 'Female', '1995-06-27', '902178254_33241469_99782324.jpeg', 2016, '2017-04-16 16:04:13', '2019-03-03 17:16:32', b'0'),
...
(125, 32, 28, 0, NULL, 0, NULL),
(126, 32, 24, 0, NULL, 0, NULL),
(127, 32, 7, 0, NULL, 0, NULL),
(128, 32, 11, 0, NULL, 0, NULL),
(129, 32, 20, 0, NULL, 0, NULL),
(130, 32, 12, 0, NULL, 0, NULL),
(131, 33, 28, 1, '2019-01-21 14:07:22', 1, '2019-01-21 14:18:49'),
(132, 33, 24, 0, NULL, 0, NULL),
(133, 33, 7, 0, NULL, 0, NULL),
(134, 33, 11, 0, NULL, 0, NULL),
(135, 33, 20, 0, NULL, 0, NULL),
(136, 33, 12, 0, NULL, 0, NULL);
...
(168, 125, NULL, NULL, NULL, 0),
(169, 126, NULL, NULL, NULL, 0),
(170, 127, NULL, NULL, NULL, 0),
(171, 128, NULL, NULL, NULL, 0),
(172, 129, NULL, NULL, NULL, 0),
(173, 130, NULL, NULL, NULL, 0),
(174, 131, 'file', '10-Chaper-5-Design-and-Implementation-Issue-57-58.docx', '633167904_894242079_396859496.docx', 20228),
(175, 132, NULL, NULL, NULL, 0),
(176, 133, NULL, NULL, NULL, 0),
(177, 134, NULL, NULL, NULL, 0),
(178, 135, NULL, NULL, NULL, 0),
(179, 136, NULL, NULL, NULL, 0);
...
(5, 'TID- 20488989', 'Smith', 'Sam', 'Lannister', 'Male', '1989-08-27 00:00:00', 'Principal', 'Visiting Lecturer', '145383144_999166647_422116105.jpg', '2017-02-20 18:40:11', '2019-02-21 04:06:53', b'1'),
...
(10, 'T-123', 'Amatong', 'Roi Larrence', 'Reyes', 'Male', '2018-12-24 00:00:00', 'Masters in Computer Science', 'Senior Web Dev', '365247707_566427159_956974259.jpg', '2018-12-31 21:42:37', '2018-12-31 22:22:34', b'1'),
...
--
ALTER TABLE `curriculum`
  MODIFY `curriculum_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `curriculum_subjects`
--
ALTER TABLE `curriculum_subjects`
  MODIFY `curriculum_subject_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `curriculum_year_sem`
--
ALTER TABLE `curriculum_year_sem`
  MODIFY `curriculum_year_sem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `loads`
  MODIFY `load_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `submitted_homeworks`
  MODIFY `submitted_homework_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT for table `submitted_homework_files`
--
ALTER TABLE `submitted_homework_files`
  MODIFY `submitted_homework_file_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=180;
