app.controller('studentProfileController', ['$scope', 'studentProfileService', function ($scope, studentProfileService) {
        ...
        if ($scope.profileForm.$valid) {
            ...
            dialogHelper.showConfirmation(title, message, function (result) {
                if (result) {
                    ...
                    studentProfileService.saveUpdatePersonalInfo($scope.profile).then((res) => {
                        if (res.data.status === 1) {
        ...
        if (isFormValid()) {
            ...
            dialogHelper.showConfirmation(title, message, function (result) {
                if (result) {
                    ...
                    studentProfileService.saveUpdateAccountInfo($scope.profile).then((res) => {
                        if (res.data.status === 1) {
    ...
    initialize = () => {
        ...
        studentProfileService.getStudentProfile().then((res) => {
