app.service('accountHomeworksService', ['$http', function($http){
    ...
    this.getHomeworkDetails = (homework_id, get_submitted_homeworks) =>{
        return $http.post(`${main_uri}/get_homework_details`, {homework_id, get_submitted_homeworks});
    }
    ...
    this.approvedHomework = (submitted_homework_id, approved_status) => {
        return $http.put(`${main_uri}/approved_homework`, {submitted_homework_id, approved_status}).then(result => {
