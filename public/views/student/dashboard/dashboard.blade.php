...
@section('content')
    ...
    <script type="text/javascript" src="/js/services/student/student.dashboard.service.js"></script>
    <script type="text/javascript" src="/js/controllers/student/student.dashboard.controller.js"></script>

    <div class="content-wrapper" ng-controller="studentDashboardController">
                                    ...
                                    <div class="box box-success">
                                        <div class="box-body box-profile">
                                            <div class="small-box bg-green">
                                                ...
                                                <a href="/student/subject/@{{subject.class_id}}/posts" class="small-box-footer">@{{subject.subject_description}} <br> (@{{subject.subject_code}}) </i></a>
                                            </div>
