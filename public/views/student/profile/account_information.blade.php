...
@section('content')
    ...
    <div class="content-wrapper" ng-controller="studentProfileController">
        <section class="content-header">
            <h1><i class="fa fa-key"></i> Account Information </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <br>
            <form name="accountProfileForm" novalidate ng-submit="saveUpdateAccountInformation()" ng-model-options="{updateOn : 'submit'}">
                <div class="container"> 
                    <div class="row">
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" ng-model="new_password" class="form-control" id="password" placeholder="Enter password&hellip;" ng-model-options="{updateOn: 'default'}">
                            </div>
