...
@section('content')
    ...
    <script src="/js/services/student/student.chat.service.js"></script>
    <script src="/js/controllers/student/student.chat.controller.js"></script>

    <div class="content-wrapper" ng-controller="studentChatController">
                        ...
                        <div class="box-header">
                            ...
                            <div class="pull-right" >
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a style="color:black;" href="#"><i class="fa fa-trash"></i> Clear Conversation</a></li>
                                </ul>
                            </div>
                        </div>
