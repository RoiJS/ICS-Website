...
@section('content')
    ...
    <script type="text/javascript" src="/js/services/student/student.messages.service.js"></script>
    <script type="text/javascript" src="/js/controllers/student/student.reply.message.controller.js"></script>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <li><a href="/student/messages/inbox">Inbox</a></li>
            <li class="active">Reply Message</li>
            </ol>
        </section>
        <!-- Main content -->
        <section class="content" ng-controller="studentReplyMessageController">
            <br>
            <div class="row">
