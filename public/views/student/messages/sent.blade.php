                                    ...
                                    <table id="table-sent-items" class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="sent_item in sent_items.getSentMessagesList()">
                                                <td><a ng-href="/student/messages/sent/@{{sent_item.sent_item_id}}">@{{userHelper.getPersonFullname(sent_item)}}</a></td>
                                                <td>@{{systemHelper.trimString(sent_item.message, 50)}}</td>
                                                <td>@{{sent_items.getTimeAgo(sent_item) | date : 'MMM d, y'}}</td>
                                                <td><a ng-href="/student/messages/forward/@{{sent_item.sent_item_id}}" data-toggle="tooltip" title="Forward" class="btn btn-default"><i class="fa fa-mail-forward"></i> </a></td>
