...
@section('content')
    ...
    <script type="text/javascript" src="/js/controllers/student/student.posts.controller.js"></script>
    <script type="text/javascript" src="/js/controllers/student/student.comments.controller.js"></script>

    <link rel="stylesheet" href="/css/shared/comments.css">
    <link rel="stylesheet" href="/css/shared/posts.css">

    <div class="content-wrapper" ng-controller="studentPostsController">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <a href="/student/subject/{{$id}}/posts/add_post" class="btn btn-success"><i class="fa fa-edit"></i> Add Post</a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                    ...
                    <div ng-repeat="post in posts"  ng-init="post_index = $index" ng-show="!status.post_loading">
                        <div class="post-list box box-widget">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools" ng-if="post.is_poster">
                                    ...
                                    <ul class="dropdown-menu-options dropdown-menu" role="menu">
                                        <li><a href="/student/subject/{{$id}}/posts/edit_post/@{{post.post_id}}"><i class="fa fa-edit"></i> Edit</a></li>
                            ...
                            <div ng-controller="studentCommentsCotroller">
