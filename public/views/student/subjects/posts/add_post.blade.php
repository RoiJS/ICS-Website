...
@section('content')
    ...
    <script type="text/javascript" src="/js/controllers/student/student.add.post.controller.js"></script>
    ...
    <div class="content-wrapper">
        ...
        <section class="content" ng-controller="studentAddPostController">
            <div class="row">
