...
@section('content')
    ...
    <script type="text/javascript" src="/js/services/admin/admin.profile.service.js"></script>
    <script type="text/javascript" src="/js/controllers/admin/admin.profile.controller.js"></script>
