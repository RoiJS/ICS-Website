...
@section('content')
    ...
    <script src="/js/controllers/teacher/teacher.edit.homeworks.controller.js"></script>

    <link rel="stylesheet" href="/css/shared/homeworks.css">

    <script>
        // Get current homework id
        var homework_id = {!! json_encode($homework_id); !!};
    </script>
    ...
    <div class="content-wrapper">
        ...
        <section class="content" ng-controller="teacherEditContoller">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row">
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                            <!--Homeworks form -->
                            <form novalidate ng-submit="saveUpdateHomework()">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label>Title:</label>
                                                    <input type="text" class="form-control" ng-model="homework.title" placeholder="Enter title&hellip;">
                                                </div>    
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control pull-right" ng-model="homework.due_date" placeholder="Enter due date&hellip;">
                                                    </div>
                                                </div>    
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    <div class="row" ng-show="!status.files_loading && !status.has_files">
                                        <div class="col-md-12">
                                ...
                                <div class="box-body homeworks-file-upload-container" ng-show="!status.files_loading && status.has_files">
                                    <div class="row">
