...
@section('content')
    ...
    <script type="text/javascript" src="/js/controllers/teacher/teacher.edit.post.controller.js"></script>
    ...
    <div class="content-wrapper">
        ...
        <section class="content" ng-controller="teacherEditPostController">
            <div class="row">
                        ...
                        <div class="box box-widget">
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    <button ng-disabled="!post_details.description" type="submit" class="btn btn-success"> <i class="fa fa-save" ></i> Post</button>
