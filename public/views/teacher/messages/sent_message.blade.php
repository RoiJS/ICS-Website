...
@section('content')
    ...
    <script type="text/javascript" src="/js/services/teacher/teacher.sent.messages.service.js"></script>
    <script type="text/javascript" src="/js/controllers/teacher/teacher.forward.message.controller.js"></script>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <li><a href="/teacher/messages/sent">Sent</a></li>
            <li class="active">Sent Message</li>
            </ol>
        </section>

        <section class="content" ng-controller="teacherForwardMessageController">
            <br>
            <div class="row">
                <div class="col-md-3">
