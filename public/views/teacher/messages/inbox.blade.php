                                ...
                                <table id="table-inbox" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="message in messages.getMessagesList()">
                                            <td><a ng-href="/teacher/messages/@{{message.message_id}}">
                                            ...
                                            <td><a data-toggle="tooltip" title="Reply" ng-href="/teacher/messages/reply/@{{message.message_id}}" class="btn btn-default"><i class="fa fa-reply"></i></a></td>
