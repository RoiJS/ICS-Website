                    ...
                    <ul class="control-sidebar-menu  ">
                        <li style="margin-left:20px;margin-bottom:30px;">
                            <div class="row">
                                ...
                                <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                    <a href="/teacher/profile/profile_picture" class="pull-right"><i class="fa fa-edit"></i> Edit</a>   
                                </div>
                            </div>
                        </li>
                        ...
                        <li style="margin-left:20px;margin-bottom:30px;">
                            <div class="row">
                                ...
                                <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                    <a href="/teacher/profile/personal_information" class="pull-right"><i class="fa fa-edit"></i> Edit</a>   
                                </div>
                            </div>
                        </li>
                        <hr style="border-top: 2px solid #d5e0d7;">
                        <li style="margin-left:20px;">
                            <div class="row">
                                ...
                                <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                    <a href="/teacher/profile/account_information" class="pull-right"><i class="fa fa-edit"></i> Edit</a>   
                                </div>
                            </div>
                        </li>
                    </ul>
