...
<body class="hold-transition skin-green-light sidebar-mini">
    ...
    <section class="content">
      <div class="error-page">
        <h2 class="headline text-yellow" style="margin:-20px 15px;"> 404</h2>
...
<script src="/assets/account/plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
...
<script src="/assets/account/dist/js/pages/dashboard.js"></script>
</body>
</html>